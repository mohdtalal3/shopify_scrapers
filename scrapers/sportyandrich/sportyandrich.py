...
BASE_URL = "https://sporty-rich.com"


graphql_url = "https://sporty-rich.myshopify.com/api/unstable/graphql.json"
headers = {
    "Content-Type": "application/json",
    "Accept": "*/*",
    "Origin": "https://sportyandrich.com",
    "Referer": "https://sportyandrich.com/",
    "User-Agent": "Mozilla/5.0",
    "x-shopify-storefront-access-token": "39b75d98553a5de7d520db1c5417ef1b"
}
    ...
    for product in products:
        ...
        for edge in product.get("images", {}).get("edges", []):
            ...
            if url and url not in seen_images:
                # Filter out men's images for women's products
                if gender_tag and gender_tag.lower() == "women":
                    # Skip images that contain "_M_" (men's images)
                    if "_M_" not in url:
                        all_images.append(url)
                else:
                    # For men's products or no gender specified, include all images
                    all_images.append(url)
            seen_images.add(url)
...
def complete_workflow_sportyandrich():

    collections = [
        {"url": "https://sportyandrich.com/collections/shop-all", "gender": "women"}
    ]
...
if __name__ == "__main__":
    ...
    complete_workflow_sportyandrich()
