...
BASE_URL = "https://cosabella.com"


graphql_url = "https://cosabella-north-america.myshopify.com/api/unstable/graphql.json"
headers = {
    "Content-Type": "application/json",
    "Accept": "*/*",
    "Origin": "https://cosabella.com",
    "Referer": "https://cosabella.com/",
    "User-Agent": "Mozilla/5.0",
    "x-shopify-storefront-access-token": "dcb5fb1b1444c8da88a0f3fc22975f44"
}
...
def clean_and_save_product_data_only_available_with_all_images_from_data(
    ...
    for product in products:
        ...
        for tag in all_tags:
            if "::" in tag:
                cleaned_tags.append(tag.split("::")[-1])
            else:
                cleaned_tags.append(tag)
        product_tags = ", ".join(tag.strip() for tag in cleaned_tags if tag.strip())
...
def complete_workflow_cosabella():

    collections = [
        {"url": "https://cosabella.com/collections/lingerie", "gender": "women"}
    ]
