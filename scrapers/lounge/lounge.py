...
BASE_URL = "https://lounge.com"


graphql_url = "https://uslounge.myshopify.com/api/unstable/graphql.json"
headers = {
    ...
    "x-shopify-storefront-access-token": "71d53f5ac461d82b0ed13b7306c6130e"
}
    ...
    for i in range(0, len(product_ids), 50):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"[✓] Batch {i//50+1} fetched")
            else:
                print(f"[✗] Failed batch {i//50+1}: {response.status_code}")
                print(response.text)
        except Exception as e:
            print(f"[!] Exception in batch {i//50+1}: {e}")
        time.sleep(1.2)
...
def complete_workflow_lounge():

    collections = [
        {"url": "https://us.lounge.com/collections/bras", "gender": "women", "product_type": "Bras"},
        {"url": "https://us.lounge.com/collections/intimates", "gender": "women", "product_type": "Intimates"},
        {"url": "https://us.lounge.com/collections/thongs-briefs", "gender": "women", "product_type": "Bottoms"},
