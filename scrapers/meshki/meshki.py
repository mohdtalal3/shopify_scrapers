...
BASE_URL = "https://meshki.com"


graphql_url = "https://meshki-us.myshopify.com/api/unstable/graphql.json"
headers = {
    "Content-Type": "application/json",
    "Accept": "*/*",
    "Origin": "https://www.meshki.us",
    "Referer": "https://www.meshki.us/",
    "User-Agent": "Mozilla/5.0",
    "x-shopify-storefront-access-token": "4634eacf108fece6cce34888753a57f5"
}
...
def complete_workflow_meshki():

    collections = [
        {"url": "https://www.meshki.us/collections/all-clothing", "gender": "women"},
    ]
