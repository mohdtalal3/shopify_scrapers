...
graphql_url = "https://gem-opticians-delhi.myshopify.com/api/unstable/graphql.json"
headers = {
    "Content-Type": "application/json",
    "Accept": "*/*",
    "Origin": "https://gemopticians.com",
    "Referer": "https://gemopticians.com/",
    ...
    for product in products:
        ...
        if gender_tag:
            if gender_tag.lower() == "men":
                ...
                gender_tags = { "womens", "women","woemen's"}
...
def complete_workflow_gemopticians():
    ...
    collections = [
        ...
        {"url": "https://gemopticians.com/collections/womens-sunglasses", "gender": "women"}
    ]
...
if __name__ == "__main__":
    ...
    complete_workflow_gemopticians()
