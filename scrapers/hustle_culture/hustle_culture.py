...
graphql_url = "https://hustleculture.co.in/api/unstable/graphql.json"
headers = {
    "Content-Type": "application/json",
    "Accept": "*/*",
    "Origin": "https://hustleculture.co.in",
    "Referer": "https://hustleculture.co.in",
    "User-Agent": "Mozilla/5.0",
    "x-shopify-storefront-access-token": "4108eea66415a6ede4379244c6baef23"
}
...
def clean_and_save_product_data_only_available_with_all_images_from_data(
    ...
    for product in products:
        ...
        gender_tags = set()
        if any(word in description.lower() for word in ["women", "woman", "women's", "womens"]):
            gender_tags = {"women's", "womens", "women"}
        else:
            gender_tags = {"men's", "mens", "men"}
        ...
        for edge in product.get("variants", {}).get("edges", []):
            ...
            sku = variant.get("sku", "")
            gid=variant.get("id", "")
            sku = gid.split("/")[-1] if gid else None
            ...
            for opt in variant.get("selectedOptions", []):
                ...
                if "color" in opt_name.lower():
                    color = opt["value"]
                elif "size" in opt_name.lower() or "title" in opt_name.lower():
                    size = opt["value"]
...
def complete_workflow_hustle_culture():

    collections = [
        {"url": "https://hustleculture.co.in/collections/new-balance-1", "gender": "men"},
        {"url":"https://hustleculture.co.in/collections/watches", "gender": "men"},
    ]
...
if __name__ == "__main__":
    ...
    complete_workflow_hustle_culture()
